    ...
    <header className="sticky top-0 z-40 bg-white border-b border-[#E1ECE3] shadow-xs px-4 md:px-8 py-3.5 flex items-center justify-between">
      ...
      <nav className="hidden md:flex items-center space-x-6">
        <button
          ...
          className={`text-xs font-bold transition-colors flex items-center gap-1.5 ${currentPage === 'inicio' ? 'text-[#1E8344]' : 'text-[#4F6C56] hover:text-[#1E8344]'
            }`}
        >
        ...
        <button
          ...
          className={`text-xs font-bold transition-colors flex items-center gap-1.5 ${currentPage === 'acerca-de' ? 'text-[#1E8344]' : 'text-[#4F6C56] hover:text-[#1E8344]'
            }`}
        >
